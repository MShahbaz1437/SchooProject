...
$con = new connectioninfo();
	...
	{
		extract($_POST);
		$qry="update Menusetup set mname='$tname',morder='$troman',mdetail='$tremark',mstatus='$mstatus' where mid='$id'";
	...
	$qry="select * from menusetup where mid='$id'";
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>UPDATE MENU</h3>
			  ...
			  <div class="form-group">
				...
				<input class="form-control"  type="text" id="troman" name="troman" placeholder="Roman Class" value="<?php echo $order ?>">
			  </div>
			  <div class="form-group">
				<label class="control-label">MENU DETAIL</label>
				<input class="form-control"  type="text" id="tremark" name="tremark" placeholder="Remark" value="<?php echo $detail ?>">
			  </div>
			   <div class="form-group">
				<label class="control-label">STATUS</label>
				<select name="mstatus" id="mstatus" class="form-control">
					<option value="Active" <? if($status1=="Active"){echo "selected=selected";} ?> value="<?php echo $status1; ?>" >Active</option>
					<option value="Deactive" <? if($status1=="Deactive"){echo 'selected=selected';} ?>  value="<?php echo $status1; ?>" >Deactive</option>
