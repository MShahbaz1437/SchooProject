...
if(isset($_POST["btn1"]))
{
	...
	if($image)
	{
	$qry="Update facilities set factitle='$tname',facdescription='$tdescription',facimage='$path',facstatus='$status1'  where  facid='$urlid'";
		$rs=$con->executequery($qry);
	}
	else
	{
	$qry="Update facilities set factitle='$tname',facdescription='$tdescription',facstatus='$status1'  where  facid='$urlid'";
	$rs=$con->executequery($qry);
	}
...
$qry1="select * from facilities where facid='$urlid'";
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
		...
		<center> 
		<?php
		echo "<img src='$gallery' style='height:100px; width:100px;' />";
		?>
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg  fa-openid"></i>&nbsp&nbsp FACILITY </h3>
				...
				<div class="form-group">
				  ...
				  <textarea class="form-control" rows="3" name="tdescription" id="tdescription" placeholder="Facility Description"><?php echo $description; ?></textarea>
				</div>
				<div class="form-group">
