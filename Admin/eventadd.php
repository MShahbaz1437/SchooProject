...
if(isset($_POST["btn1"]))
{
	extract($_POST);
	$date=date("y-m-d");		
	$qry1="insert into event (ename,date,description,status) values ('$tname','$date','$tdescription','$actstatus')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		if(Name=="")
		{
			document.getElementById("sname").innerHTML="<b>Enter Event Name</b>";
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg  fa-calendar"></i>&nbsp&nbsp EVENTS</h3>
