 ...
 if(isset($_POST["btn1"]))
{
	...
	for($p=0;$p<$count;$p++)
	{
	$qry="insert into permission (uid,mid,choose) values ('$user','$checkbox1[$p]','yes')";
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg fa-fw fa-align-right"></i>PERMISSION ADD</h3>
			  <center> 
			...
			?>
			  ...
			  <div class="form-group btn-container">
				<button class="btn btn-primary mt-2" id="btn1" name="btn1"><i class="fa fa-pencil-square-o fa-lg fa-fw"></i>INSERT</button>
			  </div>
			</form>
