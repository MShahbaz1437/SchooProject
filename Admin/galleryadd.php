...
if(isset($_POST["btn1"]))
{
	...
	$qry1="insert into gallery (gytid,name,detail,image,setdate,status) values ('$tgallerytype','$tname','$tdetail','$path','$date','$actstatus')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		if(Name=="")
		{
			document.getElementById("sname").innerHTML="<b>Enter Gallery Name</b>";
