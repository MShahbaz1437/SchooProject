	...
	$status.="<table class='table table-responsive table-striped table-bordered mt-4'>";
		$status.="<thead class='thead-dark '>";
			...
			$status.="<tr>";
				...
				$status.="<td>$row[7]</td>";
				$status.="<td>$row[8]</td>";
				$status.="<td><img src='$row[9]' style='height:100px; width:120px;' /></td>";
				$status.="<td><a href='userinfoupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i></a> &nbsp / &nbsp <a href='userinfodelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
			$status.="</tr>";
			$a++;
			}
		$status.="</thead>";	
