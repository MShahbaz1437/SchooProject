...
if(isset($_POST["btn1"]))
{
	...
	{
		$path="title/".$_FILES["timage"]["name"];
		move_uploaded_file($_FILES["timage"]["tmp_name"],$path);
	}
	$qry1="insert into titlesetup (tname,logo,temail,tcontact,tfax,taddress) values ('$tname','$path','$temail','$tcontact','$tfax','$taddress')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		var Fax=document.getElementById("tfax").value;
		...
		var reg_fax=/^[0-9]{1,3}-[0-9]{3}-[0-9]{7}$/;
		...
		if(Email=="")
		{
			document.getElementById("semail").innerHTML="Enter Your Email";
		...
		if(Contact=="")
		{
			document.getElementById("scontact").innerHTML="Enter Your Mobile";
			error=document.getElementById("scontact").style.color=" red";
			return false;
		}
		else if(!reg_mobile.test(Contact))
		{
			document.getElementById("scontact").innerHTML="Check Your Mobile";
			error=document.getElementById("scontact").style.color=" red";
			return false;
		}
		...
		if(Fax=="")
		{
			document.getElementById("sfax").innerHTML="Enter Your Fax";
			error=document.getElementById("sfax").style.color=" red";
			return false;
		}
		else if(!reg_fax.test(Fax))
		{
			document.getElementById("sfax").innerHTML="Check Your Fax";
			error=document.getElementById("sfax").style.color=" red";
			return false;
		}
		else
		...
		if(Address=="")
		{
			document.getElementById("saddress").innerHTML="Enter Your Address";
			error=document.getElementById("saddress").style.color=" red";
			return false;
		}
		else if(!reg_address.test(Address))
		{
			document.getElementById("saddress").innerHTML="Check Your Address";
			error=document.getElementById("saddress").style.color=" red";
			return false;
		}
		else
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5 col-md-5 col-lg-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="app-menu__icon fa fa-area-chart"></i>TITLE ADD</h3>
			...
			<div class="form-group">
				...
				<input class="form-control"  type="email" id="temail" name="temail" placeholder="Email"required  ><strong><span id="semail"></span></strong>
			</div>
			<div class="form-group">
				<label class="control-label">CONTACT</label>
				<input class="form-control"  type="text" id="tcontact" name="tcontact" placeholder="Contact"required  ><strong><span id="scontact"></span></strong>
			</div>
			<div class="form-group">
				<label class="control-label">FAX</label>
				<input class="form-control"  type="text" id="tfax" name="tfax" placeholder="Fax" required ><strong><span id="sfax"></span></strong>
			</div>			
			<div class="form-group">
				<label class="control-label">ADDRESS</label>
				<input class="form-control"  type="text" id="taddress" name="taddress" placeholder="Address" required ><strong><span id="saddress"></span></strong>
			</div>
