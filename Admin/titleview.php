	...
	$status.="<table class='table table-responsive table-striped table-bordered mt-4'>";
		$status.="<thead class='thead-dark '>";
			$status.="<tr>";
				...
				$status.="<th scope='col'>Logo</th>";
				$status.="<th scope='col'>Email</th>";
				$status.="<th scope='col'>Contact</th>";
				$status.="<th scope='col'>Fax</th>";
			...
			$status.="<tr>";
				$status.="<td>$a</td>";
				$status.="<td>$row[1]</td>";
				$status.="<td><img src='$row[2]' style='height:100px; width:120px;' /></td>";
				$status.="<td>$row[3]</td>";
				$status.="<td>$row[4]</td>";
				$status.="<td>$row[5]</td>";
				$status.="<td>$row[6]</td>";
				...
				$status.="<td><a href='titleupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i> </a> / <a href='titledelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
			$status.="</tr>";
			$a++;
			}
		$status.="</thead>";	
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
		...
		<center> 
					  <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>VIEW USERINFO</h3>
			<?php echo $status; ?>
		</center>	
    </main>
