...
if(isset($_POST["btn1"]))
{
	...
	$qry1="insert into eventgallery (egname,egallery,date,description,status,eid) values ('$tname','$path','$tdate','$tdescription','$status1','$eventtype')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		var reg_date=/^([0-9\-.,]{1})([0-9\-,.]{1,})([0-9]{4})$/;
		...
		if(Name=="")
		{
			document.getElementById("sname").innerHTML="<b>Enter Event Gallery Name</b>";
		...
		if(Date=="")
		{
			document.getElementById("sdate").innerHTML="<b>Enter Date</b>";
			error=document.getElementById("sdate").style.color="red";
			return false;
		}
		else if(!reg_date.test(Date))
		{
			document.getElementById("sdate").innerHTML="<b>Check Date</b>";
			error=document.getElementById("sdate").style.color="red";
			return false;
		}
		else
			...
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
					...
					<input class="form-control"  type="TEXT" id="tdate" name="tdate" placeholder="Date"  required><span id="sdate"></span>
				</div>
				<div class="form-group">
				  <label for="comment">DESCRIPTION</label>
				  <textarea class="form-control" rows="3" name="tdescription" id="tdescription" placeholder="Event Description" required></textarea><span id="sdetail"></span>
				</div>
