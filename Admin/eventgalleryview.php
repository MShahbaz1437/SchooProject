	...
	$status.="<table class='table table-responsive'>";
		$status.="<thead class='thead-dark'>";
			$status.="<tr>";
				...
				$status.="<th scope='col'>Event Type</th>";
		...
		$status.="<tbody>";
			$status.="<tr>";
				$status.="<td>$a</td>";
				$status.="<td>$row[1]</td>";
				$status.="<td><img src='$row[2]' style='height:80px; width:100px;' /></td>";
				$status.="<td>$row[3]</td>";
				$status.="<td>$row[4]</td>";
				$status.="<td>$row[6]</td>";
				$status.="<td>$row[5]</td>";
				$status.="<td><a href='eventgalleryupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i> </a>/ <a href='eventgallerydelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
			$status.="</tr>";
		$status.="</tbody>";
		$a++;
		}
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
		...
		<center> 
					  <h3 class="login-head"><i class="app-menu__icon fa fa-calendar"></i>&nbsp&nbsp EVENT VIEW</h3>
