	...
	$status.="<table class='table  table-responsive table-striped table-bordered mt-4'>";
		$status.="<thead class='thead-dark '>";
			$status.="<tr>";
				...
				$status.="<th scope='col'>Security Question</th>";
				$status.="<th scope='col'>Security Answer</th>";
				$status.="<th scope='col'>UserType</th>";
			...
			$status.="<tr>";
				...
				$status.="<td>$row[9]</td>";
				$status.="<td>$row[10]</td>";
				$status.="<td><img src='$row[11]' height='100px;' width='150px' /></td>";
				$status.="<td><a href='adminupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i></a> / <a href='admindelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
