...
{
	extract($_POST);
	$qry="insert into boardinfo (boardname,boarddetail) values ('$tname','$tdetail')";
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>BOARD ADD</h3>
			  <div class="form-group">
				<label class="control-label"> BOARD NAME</label>
				<input class="form-control"  type="text" id="tname" name="tname" placeholder="Board Name" required autofocus><span id="sname"></span>
			  </div>
			   <div class="form-group">
				  <label for="comment">BOARD DETAIL</label>
				  <textarea class="form-control" rows="3" name="tdetail" id="tdetail" placeholder="Board Detail" required></textarea><span id="sdetail"></span>
				</div> 
