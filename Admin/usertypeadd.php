...
{
	extract($_POST);
	$qry1="insert into usertype (name,detail,status) values ('$tname','$ttextarea','$actstatuss')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		var Detail=document.getElementById("ttextarea").value;
		
		// regresion expression
		
		var reg_name=/^(([a-zA-Z0-9 ]{1,}))$/;
		...
		{
			document.getElementById("sname").innerHTML="<b>Check Your Name</b>";
			error=document.getElementById("sname").style.color="red";
			return false;
		}
		else
		...
		if(Detail=="")
		{
			document.getElementById("stextarea").innerHTML="<b>Fill Detail</b>";
			error=document.getElementById("stextarea").style.color="red";
			return false;
		}
		else if(!reg_detail.test(Detail))
		{
			document.getElementById("stextarea").innerHTML="<b>Check  Detail</b>";
			error=document.getElementById("stextarea").style.color="red";
			return false;
		}
		else
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<textarea class="form-control" id="ttextarea" name="ttextarea" placeholder="Detail" required rows="3"></textarea><span id="stextarea"></span>			  
				</div>
			  <div class="form-group">
			  ...
			  <div class="form-group btn-container">
				<button class="btn btn-primary mt-2 btn-block" id="btn1" name="btn1" onClick="return validation(); "><i class="fa fa-pencil-square-o fa-lg fa-fw"></i>INSERT</button>
			  </div>
			</form>
			<b><?php echo $status; ?></b>
		</center>	
