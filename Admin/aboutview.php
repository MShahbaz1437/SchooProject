		...
		$status.="<tbody>";
			$status.="<tr>";
			 $status.="<td>$a</td>";
			  $status.="<td>$row[1]</td>";
			  $status.="<td>$row[2]</td>";
			  $status.="<td><img src='$row[3]' height='80' width='100'></td>";
			  $status.="<td><a href='aboutupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i></a> &nbsp / &nbsp <a href='aboutdelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
			$status.="</tr>";
		$status.="</tbody>";
		$a++;
		}
