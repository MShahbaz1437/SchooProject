	...
	$status.="<table class='table table-responsive'>";
		...
		$status.="<tbody>";
			$status.="<tr>";
				...
				$status.="<td>$row[3]</td>";
				$status.="<td>$row[4]</td>";
				$status.="<td><a href='eventupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i> </a>/ &nbsp <a href='eventdelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
