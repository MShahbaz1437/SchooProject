...
if(isset($_POST["btn1"]))
{
	...
	{
		$path="facility/".$_FILES["timage"]["name"];
		move_uploaded_file($_FILES["timage"]["tmp_name"],$path);
	}
	$qry1="insert into facilities (factitle,facdescription,facimage,facdate,facstatus) values ('$fname','$fdescription','$path','$date','$status1')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		var Detail=document.getElementById("fdescription").value;
		...
		if(Name=="")
		{
			document.getElementById("sname").innerHTML="<b>Enter Facility Name</b>";
			error=document.getElementById("sname").style.color="red";
			return false;
		}
		else if(!reg_name.test(Name))
		{
			document.getElementById("sname").innerHTML="<b>Check Facility Name</b>";
			error=document.getElementById("sname").style.color="red";
			return false;
		}
		else
		...
		if(Detail=="")
		{
			document.getElementById("sdetail").innerHTML="<b>Fill Detail</b>";
		...
		if(Photo=="")
		{
			document.getElementById("simage").innerHTML="<b>Plese Choose Image</b>";
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg  fa-openid"></i>&nbsp&nbsp FACILITY </h3>
				<div class="form-group">
					<label class="control-label">NAME</label>
					<input class="form-control"  type="text" id="fname" name="fname" placeholder="Name" required autofocus><span id="sname"></span>
				</div>
				<div class="form-group">
				  <label for="comment">DESCRIPTION</label>
				  <textarea class="form-control" rows="3" name="fdescription" id="fdescription" placeholder="Facility Description" required></textarea><span id="sdetail"></span>
				</div>
				<div class="form-group">
