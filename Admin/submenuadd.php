...
{
	extract($_POST);
	$qry="insert into submenu (smname,smdetail,smstatus,mid) values ('$sname','$sdescription','$status1','$menu')";
...
<html lang="en">
  <head>
	...
	function validation()
	{
		...
		var Detail=document.getElementById("sdescription").value;
		...
		if(Name=="")
		{
			document.getElementById("ssname").innerHTML="<b>Enter Submenu Name</b>";
			error=document.getElementById("ssname").style.color="red";
			return false;
		}
		else if(!reg_name.test(Name))
		{
			document.getElementById("ssname").innerHTML="<b>Check Submenu Name</b>";
			error=document.getElementById("ssname").style.color="red";
			return false;
		}
		else
		...
		if(Detail=="")
		{
			document.getElementById("ssdetail").innerHTML="<b>Enter Detail</b>";
			error=document.getElementById("ssdetail").style.color="red";
			return false;
		}
		else if(!reg_detail.test(Detail))
		{
			document.getElementById("ssdetail").innerHTML="<b>Check Detail</b>";
			error=document.getElementById("ssdetail").style.color="red";
			return false;
		}
		else
		{
			document.getElementById("ssdetail").innerHTML="";
		}
		return true;	
	}
	</script>
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg fa-fw fa-bars"></i>SUBMENU ADD</h3>
			<div class="form-group">
				<label class="control-label pt-1">SUBMENU NAME</label>
				<input class="form-control"  type="text" id="sname" name="sname" placeholder="Submenu Name" required autofocus><span id="ssname"></span>
			 </div>
			 <div class="form-group">
				  <label for="comment">DESCRIPTION</label>
				  <textarea class="form-control" rows="3" name="sdescription" id="sdescription" placeholder="Submenu Description" required></textarea><span id="ssdetail"></span>
				</div>
