...
{
	extract($_POST);
		$qry="Update event set ename='$tname',description='$tdescription',status='$actstatus' where eid='$urlid'";
	...
	$qry1="select * from event where eid='$urlid'";
      ...
      <div class="app-title">
		...
		<center> 
			<form class="login-form col-sm-5" id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
			  <h3 class="login-head"><i class="fa fa-lg  fa-calendar"></i>&nbsp&nbsp  EVENT</h3>
			  ...
			  <div class="form-group">
				  ...
				  <textarea class="form-control" rows="3" name="tdescription" id="tdescription" ><?php echo $description; ?> </textarea>
				</div>
