		...
		$status.="<tbody>";
			$status.="<tr>";
			 $status.="<td>$a</td>";
			  ...
			  $status.="<td>$row[2]</td>";
			  $status.="<td>$row[3]</td>";
			  $status.="<td><a href='gallerytypeupdate.php?id=$row[0]'><i class='fa fa-pencil' aria-hidden='true'></i></a> &nbsp / &nbsp <a href='gallerytypedelete.php?id=$row[0]'><i class='fa fa-trash-o' aria-hidden='true'></i></a></td>";
			$status.="</tr>";
		$status.="</tbody>";
		$a++;
		}
