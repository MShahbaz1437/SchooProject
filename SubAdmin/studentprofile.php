...
$photo="";
		...
		$qry="select * from  studentinfo where sid='$logid'";
		...
		if(isset($_POST["btn1"]))
		{
			...
			if($image)
			{
				$qry1="update  studentinfo set username='$tuser',password='$tpwd',email='$temail',photo='$path' where sid='$logid'";
				
			}
			else
			{
				$qry1="update  studentinfo set username='$tuser',password='$tpwd',email='$temail' where sid='$logid'";
        ...
        <div id="page-wrapper">
			...
			<center>
				<div class="col-sm-2 col-md-10">
					<?php
						echo "<img src='../docs/$photo' style='height:150px; width:200px; margin-top:5px; margin-bottom:5px;'>  ";
					?>
				</div>
			</center>
			</div>
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input id="tuser" name="tuser" type="text" class="form-control" value="<?php echo $username; ?>">
							</div>
							<div class="form-group">
