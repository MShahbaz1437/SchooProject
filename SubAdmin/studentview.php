...
$status="";
	...
	$qry1="select * from notification where classid ='all' or classid=(select classid from studentinfo where sid='$logid') order by  nid desc";
	$rs1=$con->readrecord($qry1);
	$status.="<table class=' table table-striped table-responsive'>";
	$status.="<thead>";
