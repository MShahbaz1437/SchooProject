...
$photo="";
		...
		if(isset($_POST["btn1"]))
		{
			...
			if($image)
			{
				$qry1="update admin set username='$tuser',password='$tpwd',secque='$tsque',secans='$tsans',email='$temail',joindate='$tjoindate',photo='$path' where aid='$logid'";
			}
			else
			{
				$qry1="update admin set username='$tuser',password='$tpwd',secque='$tsque',secans='$tsans',email='$temail',joindate='$tjoindate' where aid='$logid'";
			}	
       ...
       <?php include("usermenu.php"); ?>
        ...
        <div id="page-wrapper">
			...
			<div class="col-sm-2 col-md-10">
					...
					<?php
						echo "<img src='../docs/$photo' style='height:150px; width:200px; margin-top:5px;'>  ";
                    ...
                    <div class="well">
                        <form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input id="tjoindate" name="tjoindate" type="text" class="form-control" value="<?php echo $joindate; ?>">
							</div>
							<div class="form-group">
