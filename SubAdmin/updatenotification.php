	...
	if(isset($_POST["btn1"]))
		{
			...
			if($image)
			{
				$qry="update notification set nname='$tname',detail='$tdetail',classid='$class',photo='$path',status='$status2' where nid='$urlid'";
				$rs=$con->executequery($qry);

			}
			else
			{
				$qry="update notification set nname='$tname',detail='$tdetail',classid='$class',status='$status2' where nid='$urlid'";
				$rs=$con->executequery($qry);
			...
			{
				$status="Update";
				header("location:userviewnotification.php");
			}
			else
			{
				$status="Not Update";
		...
		$qry="select * from notification where nid='$urlid'";
...
<body>
    <div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="col-sm-4">
			<?php echo "<img src='$photo'; height='100px' width='100px' />"; ?>
			</div>
			</div>
            <div class="row">
			<div class="col-sm-2"></div>
                <div class="col-md-6">
                    ...
                    <div class="well">
						...
						<legend>Update/Delete Notification</legend>
							...
							<div class="from-group ">
								...
								<option value="All" value="<?php echo $status1; ?>">All</option>
								<?php echo $class;?>
									<?php
